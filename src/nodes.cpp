...
bool TextInputNode::init(cocos2d::CCSize size, float scale, const std::string& font) {
...
bool NumberInputNode::init(cocos2d::CCSize size, float scale, const std::string& font) {
...
bool FloatInputNode::init(cocos2d::CCSize size, float scale, const std::string& font) {
	if (!TextInputNode::init(size, scale, font)) return false;
	input_node->setAllowedChars("0123456789.");
	return true;
}
